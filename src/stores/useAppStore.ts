...
const mockTemplates: Template[] = [
  ...
  {
    id: 't2',
    name: 'Recebimento de Carga',
    description: 'Verificação de integridade dos pallets recebidos.',
    createdAt: '2023-10-02T10:30:00Z',
    fields: [
      { id: 'f1', type: 'text', label: 'Número da Nota Fiscal', required: true },
      { id: 'f2', type: 'number', label: 'Quantidade de Pallets' },
      { id: 'f3', type: 'checkbox', label: 'Lacre Intacto?', options: 'Sim' },
      { id: 'f4', type: 'gps', label: 'Localização da Doca' },
    ],
  },
]
