...
import { n as format, r as Download, t as AuditReportDialog } from './AuditReportDialog-CMJZG0dz.js'
import { t as FileText } from './file-text-DkCcBZWi.js'
import { t as SmartLookup } from './SmartLookup-3LgOlKaQ.js'
import { E as useSearchParams, g as Input, t as useAppStore } from './index-CdCNgsZi.js'
import {
  a as TableHeader,
  i as TableHead,
  n as TableBody,
...
function Reports() {
  ...
  const filtered = (0, import_react.useMemo)(() => {
    return audits.filter((a) => {
      ...
      if (dateTo && new Date(a.timestamp) > new Date(new Date(dateTo).getTime() + 864e5))
        return false
      return true
    })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-card p-4 rounded-lg border shadow-sm items-end',
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          ...
          visibleCount < filtered.length &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                ...
                children: ['Carregar Mais (', filtered.length - visibleCount, ' restantes)'],
              }),
            }),
        ],
      }),
...
//# sourceMappingURL=Reports-BvdzdjXB.js.map
