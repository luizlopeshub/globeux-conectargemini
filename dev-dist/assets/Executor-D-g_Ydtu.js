...
import { n as CardContent, t as Card } from './card-D2pAmwtD.js'
...
function FieldRenderer({ field, value, onChange, allAnswers, error }) {
    ...
    switch (field.type) {
      case 'text':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
          'data-uid': 'src/components/executor/FieldRenderer.tsx:38:11',
          'data-prohibitions': '[editContent]',
          value: value || '',
      ...
      case 'number':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
          'data-uid': 'src/components/executor/FieldRenderer.tsx:46:11',
          'data-prohibitions': '[editContent]',
          type: 'number',
          value: value || '',
          onChange: (e) => onChange(e.target.value),
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroup, {
          ...
          children: options.map((opt) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              'div',
              {
                'data-uid': 'src/components/executor/FieldRenderer.tsx:57:15',
                'data-prohibitions': '[editContent]',
                className:
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupItem, {
                    'data-uid': 'src/components/executor/FieldRenderer.tsx:61:17',
                    'data-prohibitions': '[editContent]',
                    value: opt,
                    id: `${field.id}-${opt}`,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                    'data-uid': 'src/components/executor/FieldRenderer.tsx:62:17',
                    'data-prohibitions': '[editContent]',
      ...
      case 'checkbox':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
          'data-uid': 'src/components/executor/FieldRenderer.tsx:71:11',
          'data-prohibitions': '[editContent]',
          className: 'flex flex-col gap-3',
          children: options.map((opt) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              'div',
              {
                'data-uid': 'src/components/executor/FieldRenderer.tsx:73:15',
                'data-prohibitions': '[editContent]',
                className:
                  'flex items-center space-x-3 bg-white p-3 rounded-md border border-input has-[:checked]:border-primary has-[:checked]:bg-primary/5 cursor-pointer',
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                    'data-uid': 'src/components/executor/FieldRenderer.tsx:85:17',
                    'data-prohibitions': '[editContent]',
                    htmlFor: `${field.id}-${opt}`,
                    className: 'flex-1 cursor-pointer',
                    children: opt,
      ...
      case 'gps':
        return value
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/executor/FieldRenderer.tsx:94:11',
              'data-prohibitions': '[editContent]',
              className:
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:95:13',
                  'data-prohibitions': '[editContent]',
                  className: 'h-4 w-4',
                }),
                ' Coord: ',
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              'data-uid': 'src/components/executor/FieldRenderer.tsx:98:11',
              'data-prohibitions': '[]',
              variant: 'outline',
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:103:13',
                  'data-prohibitions': '[editContent]',
      ...
      case 'camera':
        return value
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/executor/FieldRenderer.tsx:108:11',
              'data-prohibitions': '[]',
              className: 'relative rounded-md overflow-hidden border',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('img', {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:109:13',
                  'data-prohibitions': '[editContent]',
                  src: value,
                  alt: 'Captura',
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:110:13',
                  'data-prohibitions': '[]',
                  variant: 'destructive',
                  size: 'sm',
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:125:13',
                  'data-prohibitions': '[editContent]',
                  className: 'h-4 w-4 text-blue-500',
                }),
                ' Tirar Foto',
      ...
      case 'signature':
        return value
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              'data-uid': 'src/components/executor/FieldRenderer.tsx:130:11',
              'data-prohibitions': '[]',
              className: 'border rounded-md bg-white p-4 text-center',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('img', {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:131:13',
                  'data-prohibitions': '[editContent]',
          ...
          : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              'data-uid': 'src/components/executor/FieldRenderer.tsx:139:11',
              'data-prohibitions': '[]',
              variant: 'outline',
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PenLine, {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:144:13',
                  'data-prohibitions': '[editContent]',
                  className: 'h-6 w-6 text-muted-foreground',
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                  'data-uid': 'src/components/executor/FieldRenderer.tsx:145:13',
                  'data-prohibitions': '[]',
      ...
      case 'calculation':
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
          'data-uid': 'src/components/executor/FieldRenderer.tsx:150:11',
          'data-prohibitions': '[editContent]',
          className:
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
    'data-uid': 'src/components/executor/FieldRenderer.tsx:160:5',
    'data-prohibitions': '[editContent]',
    className: `border-muted shadow-sm ${error ? 'border-destructive/50 ring-1 ring-destructive/50' : ''}`,
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
      'data-uid': 'src/components/executor/FieldRenderer.tsx:163:7',
      'data-prohibitions': '[editContent]',
      className: 'p-5',
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
          'data-uid': 'src/components/executor/FieldRenderer.tsx:164:9',
          'data-prohibitions': '[editContent]',
          ...
          children: [
            ...
            field.required &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                'data-uid': 'src/components/executor/FieldRenderer.tsx:165:44',
                'data-prohibitions': '[]',
        ...
        error &&
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
            'data-uid': 'src/components/executor/FieldRenderer.tsx:168:19',
            'data-prohibitions': '[editContent]',
  ...
  const hardValidationErrors = (0, import_react.useMemo)(() => {
    ...
    template.fields.forEach((f) => {
      if (
        ...
        if (
          (f.hardValidationMin !== void 0 && val < f.hardValidationMin) ||
          (f.hardValidationMax !== void 0 && val > f.hardValidationMax)
        )
          errors[f.id] =
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
        ...
        'data-prohibitions': '[editContent]',
        className:
          'fixed bottom-0 left-0 right-0 p-4 bg-background/90 backdrop-blur-md border-t md:left-[16rem] z-10 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-[0_-10px_20px_rgba(0,0,0,0.05)] rounded-none',
        children: [
          hasHardErrors
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'flex items-center gap-2 text-destructive font-medium text-sm w-full sm:w-auto',
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                ...
                className:
                  'flex-1 sm:flex-none gap-2 h-12 px-8 bg-[#f59e0b] hover:bg-[#d97706] text-white disabled:bg-muted disabled:text-muted-foreground',
                children: [
...
//# sourceMappingURL=Executor-D-g_Ydtu.js.map
